-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('REPORT_CREATED', 'REPORT_VERIFIED', 'REPORT_ASSIGNED', 'REPORT_IN_PROGRESS', 'REPORT_RESOLVED', 'REPORT_REJECTED', 'REPORT_CANCELLED', 'SYSTEM');
